  ...
  return (
    <div className="fixed bottom-[180px] lg:bottom-[190px] right-4 lg:right-5 z-30">
      ...
      >
        ...
        <span className="text-[10px] text-text-muted font-mono">{labels.length}</span>
            ...
            <div className="p-3 space-y-1">
              {loading && (
                <div className="flex items-center justify-center py-4">
                  ...
                  <span className="text-[10px] text-text-muted ml-2">Loading territories...</span>
                </div>
              )}
              {labels.map((civ: any) => {
                ...
                return (
                  ...
                  >
                    ...
                    {hasCivId && <ChevronRight size={10} className="text-text-muted shrink-0" />}
                  </button>
                );
              })}
            </div>
