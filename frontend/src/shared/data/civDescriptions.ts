...
export const NAME_DESCRIPTIONS: Record<string, { summary: string; knownFor: string; imageUrl?: string }> = {
  ...
  'Armenia': { summary: 'One of the world\'s oldest civilizations, Armenia was the first nation to adopt Christianity as a state religion in 301 CE. Its kingdom persisted despite constant pressure from larger empires.', knownFor: 'First Christian nation, the Armenian alphabet, illuminated manuscripts, and cultural resilience.' , imageUrl: 'https://images.unsplash.com/photo-1605889547512-71753dbe7c27?w=640&q=80&fit=crop'},
  ...
  'Cyprus': { summary: 'A Mediterranean island at the crossroads of three continents, ruled in turn by Egyptians, Greeks, Romans, Crusaders, Venetians, and Ottomans.', knownFor: 'Copper production (the island gave copper its name), Aphrodite\'s mythical birthplace, and Crusader-era castles.' , imageUrl: 'https://images.unsplash.com/photo-1565008576549-57569a49371d?w=640&q=80&fit=crop'},
  ...
  'Minoan': { summary: 'Europe\'s first advanced civilization, based on the island of Crete from roughly 2700-1450 BCE. The Minoans built elaborate palace complexes and dominated Mediterranean trade.', knownFor: 'The Palace of Knossos, bull-leaping rituals, Linear A script (still undeciphered), and vivid fresco art.' , imageUrl: 'https://images.unsplash.com/photo-1543319859-29918585fa83?w=640&q=80&fit=crop'},
  'Chavin': { summary: 'The first major civilization in the Andes, centered on the temple complex at Chavín de Huántar in Peru (900-200 BCE). It unified Andean peoples through religious influence rather than military conquest.', knownFor: 'The Lanzón monolith, sophisticated stone architecture, a pan-Andean religious cult, and early metallurgy.' , imageUrl: 'https://images.unsplash.com/photo-1531065208531-4036c0dba3ca?w=640&q=80&fit=crop'},
  ...
  'Norte Chico': { summary: 'The oldest known civilization in the Americas, flourishing in coastal Peru from 3000-1800 BCE. It developed complex society without ceramics, writing, or warfare.', knownFor: 'The city of Caral (contemporary with Egyptian pyramids), monumental platform mounds, quipu-like recording devices, and a peaceful society based on trade.' , imageUrl: 'https://images.unsplash.com/photo-1504512485720-7d83a16ee930?w=640&q=80&fit=crop'},
  ...
  'Paracas': { summary: 'A pre-Inca civilization on the southern coast of Peru (800-100 BCE) famous for their elaborate textiles, which are considered some of the finest ever produced.', knownFor: 'The most intricate textiles in pre-Columbian America, skull trepanation surgery, the Paracas Candelabra geoglyph, and mummy bundles.' , imageUrl: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=640&q=80&fit=crop'},
  ...
  'Aboriginal tribes': { summary: 'The Indigenous peoples of Australia, representing the world\'s oldest continuous civilization with over 65,000 years of unbroken cultural history. Hundreds of distinct nations existed across the continent.', knownFor: 'The Dreamtime spiritual framework, the world\'s oldest rock art, fire-stick farming, boomerangs, and didgeridoos.' , imageUrl: 'https://images.unsplash.com/photo-1529510021255-4a1179e99095?w=640&q=80&fit=crop'},
  'Khoisan': { summary: 'The indigenous peoples of southern Africa, among the oldest human populations on Earth with a genetic lineage stretching back over 100,000 years. Their click languages are unique in the world.', knownFor: 'Click consonant languages, the world\'s oldest rock art traditions, hunter-gatherer expertise, and being among humanity\'s most ancient lineages.' , imageUrl: 'https://images.unsplash.com/photo-1515598749017-1d2ca898c936?w=640&q=80&fit=crop'},
  ...
  'Babylonia': { summary: 'The Babylonian Empire in southern Mesopotamia, centered on the city of Babylon. Under Hammurabi and later Nebuchadnezzar II, it was one of the ancient world\'s greatest powers.', knownFor: 'The Code of Hammurabi (earliest comprehensive law code), the Hanging Gardens, Ishtar Gate, and Babylonian mathematics.' , imageUrl: 'https://images.unsplash.com/photo-1709659524300-38edccca2e5d?w=640&q=80&fit=crop'},
