...
export const NAME_DESCRIPTIONS: Record<string, { summary: string; knownFor: string }> = {
  ...
  'Austronesians': { summary: 'The greatest seafaring people of the ancient world, originating from Taiwan around 3000 BCE. They colonized islands across the Pacific and Indian Oceans, reaching Madagascar, Easter Island, and New Zealand.', knownFor: 'Outrigger canoe technology, the largest language family by number of speakers, taro and breadfruit cultivation, and colonizing half the globe by sea.' },
  ...
  'Scythians': { summary: 'Nomadic warriors of the Eurasian steppe who dominated a vast territory from the Black Sea to China from the 7th to 3rd centuries BCE. They were feared horseback archers.', knownFor: 'Horse archery, gold craftsmanship (Scythian animal style), koumiss (fermented mare\'s milk), and defeating Persian King Darius through guerrilla tactics.' },
  'Hittites': { summary: 'A powerful Bronze Age empire based in Anatolia (modern Turkey) that rivaled Egypt and Babylon. They fought Ramesses II at the Battle of Kadesh, one of the largest chariot battles in history.', knownFor: 'Iron smelting (among the first), the world\'s earliest known peace treaty (with Egypt), cuneiform archives, and advanced chariot warfare.' },
  'Olmec': { summary: 'The "mother culture" of Mesoamerica, flourishing from 1500-400 BCE along the Gulf Coast of Mexico. They laid the foundations for all later Mesoamerican civilizations.', knownFor: 'Colossal stone heads, the Mesoamerican ballgame, early writing and calendar systems, and jade craftsmanship.' },
  'Minoan': { summary: 'Europe\'s first advanced civilization, based on the island of Crete from roughly 2700-1450 BCE. The Minoans built elaborate palace complexes and dominated Mediterranean trade.', knownFor: 'The Palace of Knossos, bull-leaping rituals, Linear A script (still undeciphered), and vivid fresco art.' },
  ...
  'Indus valley civilization': { summary: 'One of the three earliest urban civilizations (alongside Mesopotamia and Egypt), flourishing in the Indus River valley from 3300-1300 BCE with remarkably advanced city planning.', knownFor: 'Grid-planned cities, indoor plumbing, standardized weights and measures, the Great Bath of Mohenjo-daro, and still-undeciphered script.' },
  'Kerma': { summary: 'The earliest urban civilization in sub-Saharan Africa, based along the Nile in modern Sudan (2500-1500 BCE). Kerma was a powerful rival to Egyptian control of Nubia.', knownFor: 'Massive mudbrick temple (the Deffufa), elaborate burial practices, bronze-working, and resistance against Egyptian expansion.' },
  'Saba': { summary: 'The biblical Kingdom of Sheba, located in modern-day Yemen. Saba controlled the lucrative incense trade routes that connected Arabia to the Mediterranean world.', knownFor: 'The Queen of Sheba legend, the Marib Dam (an ancient engineering marvel), frankincense trade, and monumental stone temples.' },
  ...
  'Norte Chico': { summary: 'The oldest known civilization in the Americas, flourishing in coastal Peru from 3000-1800 BCE. It developed complex society without ceramics, writing, or warfare.', knownFor: 'The city of Caral (contemporary with Egyptian pyramids), monumental platform mounds, quipu-like recording devices, and a peaceful society based on trade.' },
  ...
  'Urartu': { summary: 'A powerful Iron Age kingdom in the Armenian Highlands (860-590 BCE) that rivaled the Assyrian Empire. They were master builders and metalworkers.', knownFor: 'Fortress citadels, sophisticated irrigation canals, bronze working, and resistance against Assyrian expansion.' },
  'Thrace': { summary: 'Ancient peoples of southeastern Europe (modern Bulgaria, Turkey, Greece) who were renowned warriors and horsemen. Spartacus, who led the great slave revolt against Rome, was Thracian.', knownFor: 'Gold treasure of Panagyurishte, Orpheus mythology, fierce warrior culture, and Spartacus\'s rebellion against Rome.' },
  ...
  'Aboriginal tribes': { summary: 'The Indigenous peoples of Australia, representing the world\'s oldest continuous civilization with over 65,000 years of unbroken cultural history. Hundreds of distinct nations existed across the continent.', knownFor: 'The Dreamtime spiritual framework, the world\'s oldest rock art, fire-stick farming, boomerangs, and didgeridoos.' },
  'Khoisan': { summary: 'The indigenous peoples of southern Africa, among the oldest human populations on Earth with a genetic lineage stretching back over 100,000 years. Their click languages are unique in the world.', knownFor: 'Click consonant languages, the world\'s oldest rock art traditions, hunter-gatherer expertise, and being among humanity\'s most ancient lineages.' },
