...
export const NAME_DESCRIPTIONS: Record<string, { summary: string; knownFor: string; imageUrl?: string }> = {
  ...
  'Sweden': { summary: 'A Scandinavian kingdom that grew from Viking-era origins into a major Baltic power. During the 17th century under Gustavus Adolphus, Sweden controlled much of the Baltic and was one of Europe\'s great military powers. Swedish innovations in infantry tactics revolutionized warfare.', knownFor: 'Viking heritage, Baltic empire, military innovation, the Vasa warship, and ABBA.', imageUrl: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=640&q=80&fit=crop' },
  ...
  'Cyprus': { summary: 'A Mediterranean island at the crossroads of three continents, ruled in turn by Egyptians, Greeks, Romans, Crusaders, Venetians, and Ottomans.', knownFor: 'Copper production (the island gave copper its name), Aphrodite\'s mythical birthplace, and Crusader-era castles.' , imageUrl: 'https://images.unsplash.com/photo-1569770725012-58fac5eec229?w=640&q=80&fit=crop'},
  ...
  'Austronesians': { summary: 'The greatest seafaring people of the ancient world, originating from Taiwan around 3000 BCE. They colonized islands across the Pacific and Indian Oceans, reaching Madagascar, Easter Island, and New Zealand.', knownFor: 'Outrigger canoe technology, the largest language family by number of speakers, taro and breadfruit cultivation, and colonizing half the globe by sea.' , imageUrl: 'https://images.unsplash.com/photo-1614315517650-3771cf72d18a?w=640&q=80&fit=crop'},
  ...
  'Saba': { summary: 'The biblical Kingdom of Sheba, located in modern-day Yemen. Saba controlled the lucrative incense trade routes that connected Arabia to the Mediterranean world.', knownFor: 'The Queen of Sheba legend, the Marib Dam (an ancient engineering marvel), frankincense trade, and monumental stone temples.' , imageUrl: 'https://images.unsplash.com/photo-1509316785289-025f5b846b35?w=640&q=80&fit=crop'},
  ...
  'Khoisan': { summary: 'The indigenous peoples of southern Africa, among the oldest human populations on Earth with a genetic lineage stretching back over 100,000 years. Their click languages are unique in the world.', knownFor: 'Click consonant languages, the world\'s oldest rock art traditions, hunter-gatherer expertise, and being among humanity\'s most ancient lineages.' , imageUrl: 'https://images.unsplash.com/photo-1559041881-74dd9fd9b600?w=640&q=80&fit=crop'},
